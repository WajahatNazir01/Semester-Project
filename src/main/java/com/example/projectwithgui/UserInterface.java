...
//        Image image = new Image("tools.png"); // Ensure the image is placed in src/resources
//        ImageView imageView = new ImageView(image);

        // Set the image as the button's graphic
        //tools.setGraphic(imageView);
...
//    }
    ...
    private void showCheckout() {
        ...
        placeOrderButton.setStyle("-fx-background-color: #d88f1e; -fx-text-fill: #000000; -fx-font-size: 14px; -fx-font-weight: bold;");
        placeOrderButton.setOnAction(e -> {
            //collecting checkout data to store it in file
            ...
            try (PrintWriter writer = new PrintWriter(new FileWriter("orderDetails.txt", true))) {
                ...
                //storing revenue in seperate file to show admin when needed
